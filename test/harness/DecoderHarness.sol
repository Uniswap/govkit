...
import {L1CrossDomainMessengerDecoder} from "../../src/bridges/decoders/L1CrossDomainMessengerDecoder.sol";
...
contract DecoderHarness {
    function decodeFxRoot(Call memory fxRootCall) external pure returns (
        address,
        address,
        Call[] memory
    ) {
    ...
    function decodeInbox(Call memory inboxCall) external pure returns (
        address,
        address,
        uint256,
        uint256,
    ...
    function decodeL1CrossDomainMessenger(Call memory l1CrossDomainMessengerCall) external pure returns (
        address,
        address,
        uint32,
        Call memory
    ...
    function decodeOptimismPortal2(Call memory optimismPortal2Call) external pure returns (
        address,
        uint64,
        Call memory
    ) {
    ...
    function decodeWormhole(Call memory wormholeCall) external pure returns (
        address,
        address,
        uint256,
        uint256,
