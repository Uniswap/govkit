...
contract WormholeChainIdTest is Test {
    function testChainIdToWormholeChainId() external {
        assertEq(WormholeChainId.chainIdToWormholeChainId(ChainId.Avalanche), WormholeChainId.Avalanche);
        assertEq(WormholeChainId.chainIdToWormholeChainId(ChainId.BNBChain), WormholeChainId.BNBChain);
        assertEq(WormholeChainId.chainIdToWormholeChainId(ChainId.Ethereum), WormholeChainId.Ethereum);
        ...
        assertEq(WormholeChainId.chainIdToWormholeChainId(ChainId.RootStock), WormholeChainId.RootStock);
    ...
    function testWormholeChainIdToChainId() external {
        assertEq(WormholeChainId.wormholeChainIdToChainId(WormholeChainId.Avalanche), ChainId.Avalanche);
        assertEq(WormholeChainId.wormholeChainIdToChainId(WormholeChainId.BNBChain), ChainId.BNBChain);
        assertEq(WormholeChainId.wormholeChainIdToChainId(WormholeChainId.Ethereum), ChainId.Ethereum);
        ...
        assertEq(WormholeChainId.wormholeChainIdToChainId(WormholeChainId.RootStock), ChainId.RootStock);
